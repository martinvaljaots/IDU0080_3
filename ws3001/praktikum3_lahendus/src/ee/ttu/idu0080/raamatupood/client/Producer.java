...
public class Producer {
	...
	protected void sendLoop(Session session, MessageProducer producer)
		...
		for (int i = 0; i < messageCount || messageCount == 0; i++) {
			...
			Toode toode1 = new Toode(i+1, "Radiaator", new BigDecimal(99.99));
			Toode toode2 = new Toode(i+2, "Lamp", new BigDecimal(19.99));
			Toode toode3 = new Toode(i+3, "Riiul", new BigDecimal(60.55));
			
			//toodete lisamine tellimusse
			TellimuseRida tellimuseRida = new TellimuseRida (toode1, i+1);
			tellimus.addTellimuseRida(tellimuseRida);
			
			tellimuseRida = new TellimuseRida (toode2, i+2);
			tellimus.addTellimuseRida(tellimuseRida);
			
			tellimuseRida = new TellimuseRida (toode3, i+3);
			tellimus.addTellimuseRida(tellimuseRida);
